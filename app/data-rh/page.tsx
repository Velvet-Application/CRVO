...
import DirectFileImport from "./direct-file-import-v4";
...
export default function DataRhPage(){
  return <main className={styles.page}>
    ...
    <section className={styles.grid}>
      ...
      <article><span>2</span><h2>Temps pointé facturé</h2><p>Temps facturé par intervention et par collaborateur. La période d'arrêté est obligatoire afin de comparer les heures vendues et achetées sur exactement la même période.</p></article>
    ...
    <DirectFileImport />
    <PayrollStaffImport />
    <section className={styles.panel}><div><span>PROCESSUS</span><h2>Contrôle automatique</h2></div><div className={styles.ready}><i/><strong>Fichier → lecture native → contrôle période → intégration → consolidation</strong><p>Les colonnes réelles des exports CRVO sont reconnues avant envoi. Pour la productivité, aucun ratio n'est calculé si la période des heures vendues n'est pas certifiée identique à celle des heures achetées. Les sorties collaborateurs restent des désactivations logiques : aucun historique n'est effacé.</p></div></section>
  </main>;
}
