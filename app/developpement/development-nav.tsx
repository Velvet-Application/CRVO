...
export default function DevelopmentModuleNav(){
  ...
  return <nav aria-label="Modules SAS développement" style={{position:"fixed",zIndex:1000,top:8,left:"50%",transform:"translateX(-50%)",display:"flex",gap:4,padding:4,border:"1px solid #cddfe9",borderRadius:12,background:"rgba(255,255,255,.96)",boxShadow:"0 8px 24px rgba(0,79,159,.12)",backdropFilter:"blur(8px)"}}>
