  ...
  return <main style={{minHeight:"100vh",padding:"86px 28px 40px",background:"linear-gradient(180deg,#eef7fc 0%,#f8fbfd 55%,#fff 100%)",fontFamily:"Exo,Arial,sans-serif",color:"#173447"}}>
    <div style={{maxWidth:1180,margin:"0 auto"}}>
      ...
      <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:18}}>
        ...
        <a href="/expertise-mobile" style={{display:"block",padding:24,border:"1px solid #d8e5eb",borderTop:"5px solid #55b779",borderRadius:18,background:"#fff",boxShadow:"0 14px 34px rgba(0,79,159,.08)",textDecoration:"none",color:"inherit"}}>
          <span style={{fontSize:9,fontWeight:800,letterSpacing:".1em",color:"#34835c"}}>PWA · MOBILE UNIQUEMENT</span><h2 style={{margin:"9px 0 8px",color:"#004f9f",fontSize:24}}>Expertise terrain</h2><p style={{margin:0,color:"#6e8493",lineHeight:1.55}}>Même dossier expertise dans l'interface PWA pour la prise de photos et la saisie sur smartphone. Cet accès n'est plus un onglet du module desktop.</p><strong style={{display:"inline-block",marginTop:20,color:"#004f9f"}}>OUVRIR LA PWA →</strong>
        </a>
      </section>

      <section style={{marginTop:24,padding:18,borderRadius:14,border:"1px solid #f0d477",background:"#fff9e6",color:"#6d5a12",fontSize:11,lineHeight:1.6}}><strong>Garde-fou SAS :</strong> la nouvelle chaîne expertise est persistée dans des tables dédiées KPI CRVO pour permettre l'audit et le parcours client. Elle ne modifie aucun statut MecaPlanning Factory / Fleetback.</section>
    </div>
  </main>;
}
