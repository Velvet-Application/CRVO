...
export default function NotificationCenter(){
  ...
  return <>
    ...
    <style>{`
      .crvo-notification-bell{position:fixed;right:18px;top:17px;z-index:8500;width:38px;height:38px;border:1px solid #d6e3ea;border-radius:13px;background:rgba(255,255,255,.92);backdrop-filter:blur(14px);box-shadow:0 6px 22px rgba(19,58,82,.09);display:grid;place-items:center;cursor:pointer;color:#004f9f}
      ...
      @media(max-width:700px){.crvo-notification-bell{right:12px;top:12px}.crvo-notification-panel{right:10px;top:58px}.crvo-notification-toast{right:16px;bottom:16px}}
