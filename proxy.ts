...
function adminOnlyPath(path:string){return path.startsWith("/animation-mensuelle/payplan")||path.startsWith("/animation-mensuelle/acces")||path.startsWith("/api/payplan")||path==="/data-rh"||path.startsWith("/api/data-import")||path==="/atelier"||path==="/direction"||path.startsWith("/api/kiosk/");}
