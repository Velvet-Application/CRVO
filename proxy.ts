...
type Session={ok:boolean;role:"admin"|"user";must_change_password:boolean;access_profile:"admin"|"service_manager"|"team_manager"|"custom"|"transphere"|"transphere_manager"|"hr";page_permissions:string[];productivity_scopes:string[];team_scopes:string[];can_manage_bonus_workflow:boolean;};
...
function teamManagerAllowed(path:string){return path==="/equipe"||path.startsWith("/api/team-dashboard")||path.startsWith("/temps-travail")||path.startsWith("/api/worktime");}
